...
type _OrganizationItem OrganizationItem
...
func (o *OrganizationItem) GetOwnerId() int32 {
...
// and a boolean to check if the value has been set.
func (o *OrganizationItem) GetOwnerIdOk() (*int32, bool) {
	if o == nil || IsNil(o.OwnerId) {
		return nil, false
	}
...
func (o *OrganizationItem) SetOwnerId(v int32) {
	o.OwnerId = &v
}
...
func (o *OrganizationItem) GetIsDeleted() bool {
...
// and a boolean to check if the value has been set.
func (o *OrganizationItem) GetIsDeletedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsDeleted) {
		return nil, false
	}
...
func (o *OrganizationItem) HasIsDeleted() bool {
	if o != nil && !IsNil(o.IsDeleted) {
		return true
	}
...
func (o *OrganizationItem) SetIsDeleted(v bool) {
	o.IsDeleted = &v
}

// GetVisibleTo returns the VisibleTo field value if set, zero value otherwise.
func (o *OrganizationItem) GetVisibleTo() int32 {
...
// and a boolean to check if the value has been set.
func (o *OrganizationItem) GetVisibleToOk() (*int32, bool) {
	if o == nil || IsNil(o.VisibleTo) {
		return nil, false
	}
...
func (o *OrganizationItem) SetVisibleTo(v int32) {
	o.VisibleTo = &v
}

// GetAddress returns the Address field value if set, zero value otherwise.
func (o *OrganizationItem) GetAddress() OrganizationItemAddress {
...
// and a boolean to check if the value has been set.
func (o *OrganizationItem) GetAddressOk() (*OrganizationItemAddress, bool) {
	if o == nil || IsNil(o.Address) {
		return nil, false
	}
...
func (o *OrganizationItem) SetAddress(v OrganizationItemAddress) {
	o.Address = &v
}

// GetLabelIds returns the LabelIds field value if set, zero value otherwise.
func (o *OrganizationItem) GetLabelIds() []int32 {
...
// and a boolean to check if the value has been set.
func (o *OrganizationItem) GetLabelIdsOk() ([]int32, bool) {
	if o == nil || IsNil(o.LabelIds) {
		return nil, false
	}
...
func (o *OrganizationItem) HasLabelIds() bool {
	if o != nil && !IsNil(o.LabelIds) {
		return true
	}
...
func (o *OrganizationItem) GetWebsiteOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrganizationItem) HasWebsite() bool {
...
func (o *OrganizationItem) SetWebsite(v string) {
	o.Website.Set(&v)
}
// SetWebsiteNil sets the value for Website to be an explicit nil
func (o *OrganizationItem) SetWebsiteNil() {
	o.Website.Set(nil)
}

// UnsetWebsite ensures that no value is present for Website, not even an explicit nil
func (o *OrganizationItem) UnsetWebsite() {
	o.Website.Unset()
}

// GetLinkedin returns the Linkedin field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *OrganizationItem) GetLinkedin() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OrganizationItem) GetLinkedinOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrganizationItem) HasLinkedin() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OrganizationItem) GetIndustryOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrganizationItem) HasIndustry() bool {
...
func (o *OrganizationItem) GetAnnualRevenue() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OrganizationItem) GetAnnualRevenueOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrganizationItem) HasAnnualRevenue() bool {
...
func (o *OrganizationItem) GetEmployeeCount() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *OrganizationItem) GetEmployeeCountOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrganizationItem) HasEmployeeCount() bool {
...
// and a boolean to check if the value has been set.
func (o *OrganizationItem) GetCustomFieldsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.CustomFields) {
...
func (o *OrganizationItem) HasCustomFields() bool {
	if o != nil && !IsNil(o.CustomFields) {
		return true
	}
...
func (o *OrganizationItem) SetCustomFields(v map[string]interface{}) {
	o.CustomFields = v
}
...
func (o *OrganizationItem) UnmarshalJSON(data []byte) (err error) {
	varOrganizationItem := _OrganizationItem{}

	err = json.Unmarshal(data, &varOrganizationItem)

	if err != nil {
		return err
	}

	*o = OrganizationItem(varOrganizationItem)
