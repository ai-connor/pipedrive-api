...
func (o *UpdateOrganizationRequest) GetAddTime() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateOrganizationRequest) GetAddTimeOk() (*string, bool) {
	if o == nil || IsNil(o.AddTime) {
		return nil, false
	}
...
func (o *UpdateOrganizationRequest) HasAddTime() bool {
	if o != nil && !IsNil(o.AddTime) {
		return true
	}
...
func (o *UpdateOrganizationRequest) SetAddTime(v string) {
	o.AddTime = &v
}

// GetUpdateTime returns the UpdateTime field value if set, zero value otherwise.
func (o *UpdateOrganizationRequest) GetUpdateTime() string {
...
// and a boolean to check if the value has been set.
func (o *UpdateOrganizationRequest) GetUpdateTimeOk() (*string, bool) {
	if o == nil || IsNil(o.UpdateTime) {
		return nil, false
	}
...
func (o *UpdateOrganizationRequest) HasUpdateTime() bool {
	if o != nil && !IsNil(o.UpdateTime) {
		return true
	}
...
func (o *UpdateOrganizationRequest) SetUpdateTime(v string) {
	o.UpdateTime = &v
}

// GetVisibleTo returns the VisibleTo field value if set, zero value otherwise.
func (o *UpdateOrganizationRequest) GetVisibleTo() int32 {
...
// and a boolean to check if the value has been set.
func (o *UpdateOrganizationRequest) GetVisibleToOk() (*int32, bool) {
	if o == nil || IsNil(o.VisibleTo) {
		return nil, false
	}
...
func (o *UpdateOrganizationRequest) SetVisibleTo(v int32) {
	o.VisibleTo = &v
}

// GetLabelIds returns the LabelIds field value if set, zero value otherwise.
func (o *UpdateOrganizationRequest) GetLabelIds() []int32 {
...
// and a boolean to check if the value has been set.
func (o *UpdateOrganizationRequest) GetLabelIdsOk() ([]int32, bool) {
	if o == nil || IsNil(o.LabelIds) {
		return nil, false
	}
...
func (o *UpdateOrganizationRequest) HasLabelIds() bool {
	if o != nil && !IsNil(o.LabelIds) {
		return true
	}
...
func (o *UpdateOrganizationRequest) SetLabelIds(v []int32) {
	o.LabelIds = v
}

// GetAddress returns the Address field value if set, zero value otherwise.
func (o *UpdateOrganizationRequest) GetAddress() OrganizationItemAddress {
...
// and a boolean to check if the value has been set.
func (o *UpdateOrganizationRequest) GetAddressOk() (*OrganizationItemAddress, bool) {
	if o == nil || IsNil(o.Address) {
		return nil, false
	}
...
func (o *UpdateOrganizationRequest) HasAddress() bool {
	if o != nil && !IsNil(o.Address) {
		return true
	}
...
func (o *UpdateOrganizationRequest) SetAddress(v OrganizationItemAddress) {
	o.Address = &v
}

// GetCustomFields returns the CustomFields field value if set, zero value otherwise.
func (o *UpdateOrganizationRequest) GetCustomFields() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *UpdateOrganizationRequest) GetCustomFieldsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.CustomFields) {
...
func (o *UpdateOrganizationRequest) HasCustomFields() bool {
	if o != nil && !IsNil(o.CustomFields) {
		return true
	}
...
func (o *UpdateOrganizationRequest) SetCustomFields(v map[string]interface{}) {
	o.CustomFields = v
}
...
func (o *UpdateOrganizationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varUpdateOrganizationRequest)
