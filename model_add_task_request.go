...
func NewAddTaskRequest(title string, projectId int32) *AddTaskRequest {
	this := AddTaskRequest{}
	this.Title = title
...
func (o *AddTaskRequest) GetProjectId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AddTaskRequest) GetProjectIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddTaskRequest) GetParentTaskIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddTaskRequest) UnsetParentTaskId() {
...
func (o *AddTaskRequest) UnsetDescription() {
	o.Description.Unset()
}

// GetDone returns the Done field value if set, zero value otherwise.
func (o *AddTaskRequest) GetDone() int32 {
...
// and a boolean to check if the value has been set.
func (o *AddTaskRequest) GetDoneOk() (*int32, bool) {
	if o == nil || IsNil(o.Done) {
		return nil, false
	}
	return o.Done, true
...
func (o *AddTaskRequest) SetDone(v int32) {
	o.Done = &v
}

// GetMilestone returns the Milestone field value if set, zero value otherwise.
func (o *AddTaskRequest) GetMilestone() int32 {
...
// and a boolean to check if the value has been set.
func (o *AddTaskRequest) GetMilestoneOk() (*int32, bool) {
	if o == nil || IsNil(o.Milestone) {
		return nil, false
	}
...
func (o *AddTaskRequest) HasMilestone() bool {
	if o != nil && !IsNil(o.Milestone) {
		return true
	}
...
func (o *AddTaskRequest) SetMilestone(v int32) {
	o.Milestone = &v
}
...
func (o *AddTaskRequest) UnsetDueDate() {
	o.DueDate.Unset()
}

// GetStartDate returns the StartDate field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AddTaskRequest) GetStartDate() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AddTaskRequest) GetStartDateOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddTaskRequest) HasStartDate() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AddTaskRequest) GetAssigneeIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddTaskRequest) UnsetAssigneeId() {
	o.AssigneeId.Unset()
}

// GetAssigneeIds returns the AssigneeIds field value if set, zero value otherwise.
func (o *AddTaskRequest) GetAssigneeIds() []int32 {
...
// and a boolean to check if the value has been set.
func (o *AddTaskRequest) GetAssigneeIdsOk() ([]int32, bool) {
	if o == nil || IsNil(o.AssigneeIds) {
		return nil, false
	}
...
func (o *AddTaskRequest) HasAssigneeIds() bool {
	if o != nil && !IsNil(o.AssigneeIds) {
		return true
	}
...
func (o *AddTaskRequest) SetAssigneeIds(v []int32) {
	o.AssigneeIds = v
}

// GetPriority returns the Priority field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AddTaskRequest) GetPriority() int32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AddTaskRequest) GetPriorityOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AddTaskRequest) HasPriority() bool {
...
func (o *AddTaskRequest) UnsetPriority() {
	o.Priority.Unset()
}
...
func (o *AddTaskRequest) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAddTaskRequest)
