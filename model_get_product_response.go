...
func (o *GetProductResponse) GetSuccess() bool {
...
func (o *GetProductResponse) GetSuccessOk() (*bool, bool) {
	if o == nil || IsNil(o.Success) {
		return nil, false
	}
...
func (o *GetProductResponse) HasSuccess() bool {
	if o != nil && !IsNil(o.Success) {
		return true
	}
...
func (o *GetProductResponse) SetSuccess(v bool) {
	o.Success = &v
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *GetProductResponse) GetData() GetProductResponseData {
...
// and a boolean to check if the value has been set.
func (o *GetProductResponse) GetDataOk() (*GetProductResponseData, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *GetProductResponse) SetData(v GetProductResponseData) {
	o.Data = &v
}
...
func (o *GetProductResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varGetProductResponse)
