...
func (o *GetActivityFields200ResponseDataInnerOptionsInner) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *GetActivityFields200ResponseDataInnerOptionsInner) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *GetActivityFields200ResponseDataInnerOptionsInner) SetId(v int32) {
	o.Id = &v
}
